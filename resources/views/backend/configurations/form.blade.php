        ...
        <div class="d-flex gap-4">
            ...
            <div class="mb-3">
                ...
                @if($configuration->favicon)
                    <img src="{{ asset('storage/configuration/' . $configuration->favicon) }}" alt="Favicon" class="img-thumbnail mt-2" width="100">
                @endif
            </div>
        </div>
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-4 tilebox-one">
                    ...
                    <div class="form-check">
                        ...
                        <input type="checkbox" name="show_instagram" id="show_instagram" class="form-check-input" value="1" {{ old('show_instagram', $configuration->show_instagram) ? 'checked' : '' }}>
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-check mb-1">
                        ...
                        <input type="checkbox" name="show_youtube" id="show_youtube" class="form-check-input" value="1" {{ old('show_youtube', $configuration->show_youtube) ? 'checked' : '' }}>
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-check mb-1">
                        ...
                        <input type="checkbox" name="show_twitter" id="show_twitter" class="form-check-input" value="1" {{ old('show_twitter', $configuration->show_twitter) ? 'checked' : '' }}>
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-check mb-1">
                        ...
                        <input type="checkbox" name="show_facebook" id="show_facebook" class="form-check-input" value="1" {{ old('show_facebook', $configuration->show_facebook) ? 'checked' : '' }}>
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-check mb-1">
                        ...
                        <input type="checkbox" name="show_whatsapp" id="show_whatsapp" class="form-check-input" value="1" {{ old('show_whatsapp', $configuration->show_whatsapp) ? 'checked' : '' }}>
